...
namespace FlyweightExample
{
    ...
    class PanelHouse : House
    {
        ...
        {
            Console.WriteLine("ѕостроен панельный дом из 16 этажей; координаты: {0} широты и {1} долготы",
                latitude, longitude);
        }
    }
    class BrickHouse : House
    {
        ...
        public override void Build(double longitude, double latitude)
        {
            Console.WriteLine("ѕостроен кирпичный дом из 5 этажей; координаты: {0} широты и {1} долготы",
                latitude, longitude);
        }
    }
